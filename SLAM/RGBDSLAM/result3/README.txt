...
PARAMETERS:
	...
	<node pkg="rgbdslam" type="rgbdslam" name="rgbdslam" cwd="node" required="true" output="screen"> 
	    ...
	    <param name="config/max_keypoints"                 value="200"/><!-- Extract no more than this many keypoints -->
	    ...
	    <param name="config/cloud_creation_skip_step"      value="4"/> <!-- Heavily subsample point cloud during creation -->
	  </node>	

...
PARAMETERS:
    ...
    <param name="config/max_keypoints"                 value="400"/><!-- Extract no more than this many keypoints -->
    <param name="config/max_matches"                   value="200"/><!-- Keep the best n matches (important for ORB to set lower than max_keypoints) -->
    ...
    <param name="config/nn_distance_ratio"             value="1.5"/><!-- set empirically -->
    <param name="config/ransac_iterations"             value="500"/><!-- set empirically -->
